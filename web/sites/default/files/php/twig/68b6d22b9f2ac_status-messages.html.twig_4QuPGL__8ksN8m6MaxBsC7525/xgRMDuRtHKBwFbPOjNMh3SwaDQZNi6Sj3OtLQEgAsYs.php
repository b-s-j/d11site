...
class __TwigTemplate_8c8a82362ed619d1f4c13d01c540bfa8 extends Template
{
            ...
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), $context["messages"]) > 1)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                    ...
                    if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                        if (array_key_exists("xb_slot_ids", $context) && in_array("message", $context["xb_slot_ids"], TRUE)) {
                            yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "start", $context["xb_uuid"], "message");
                        } else {
                            yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "start", $context["xb_uuid"], "message");
                        }
                    }
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $context["message"], "html", null, true);
                    if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                        if (array_key_exists("xb_slot_ids", $context) && in_array("message", $context["xb_slot_ids"], TRUE)) {
                            yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "end", $context["xb_uuid"], "message");
                        } else {
                            yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "end", $context["xb_uuid"], "message");
                        }
                    }
                    yield "</li>
                ";
...
";
    ...
    {
        return array (  197 => 74,  183 => 73,  180 => 72,  175 => 68,  169 => 66,  165 => 64,  142 => 62,  138 => 61,  135 => 60,  133 => 59,  130 => 58,  125 => 55,  122 => 54,  119 => 53,  116 => 52,  113 => 51,  110 => 50,  107 => 49,  104 => 48,  101 => 47,  99 => 46,  94 => 44,  91 => 43,  89 => 42,  83 => 41,  80 => 40,  78 => 39,  77 => 36,  76 => 35,  73 => 34,  71 => 31,  70 => 28,  68 => 27,  51 => 26,  44 => 22,);
    }
