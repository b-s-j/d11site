...
class __TwigTemplate_4e95686a09ab8f53ea7880f4293c3956 extends Template
{
    ...
    ";
        ...
        ";
            ...
            <a href=\"";
                ...
                if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                    if (array_key_exists("xb_slot_ids", $context) && in_array("site_name", $context["xb_slot_ids"], TRUE)) {
                        yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "start", $context["xb_uuid"], "site_name");
                    } else {
                        yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "start", $context["xb_uuid"], "site_name");
                    }
                }
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["site_name"] ?? null), "html", null, true);
                if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                    if (array_key_exists("xb_slot_ids", $context) && in_array("site_name", $context["xb_slot_ids"], TRUE)) {
                        yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "end", $context["xb_uuid"], "site_name");
                    } else {
                        yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "end", $context["xb_uuid"], "site_name");
                    }
                }
                yield "</a>
          </div>
        ";
            ...
            if ((($tmp = ($context["site_slogan"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                    if (array_key_exists("xb_slot_ids", $context) && in_array("site_slogan", $context["xb_slot_ids"], TRUE)) {
                        yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "start", $context["xb_uuid"], "site_slogan");
                    } else {
                        yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "start", $context["xb_uuid"], "site_slogan");
                    }
                }
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["site_slogan"] ?? null), "html", null, true);
                if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                    if (array_key_exists("xb_slot_ids", $context) && in_array("site_slogan", $context["xb_slot_ids"], TRUE)) {
                        yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "end", $context["xb_uuid"], "site_slogan");
                    } else {
                        yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "end", $context["xb_uuid"], "site_slogan");
                    }
                }
                yield "</div>
        ";
