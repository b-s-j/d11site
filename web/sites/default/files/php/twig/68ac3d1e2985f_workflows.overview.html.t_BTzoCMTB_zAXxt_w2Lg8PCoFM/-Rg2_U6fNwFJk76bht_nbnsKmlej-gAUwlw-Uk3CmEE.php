...
class __TwigTemplate_32611f0ea4fe6661b7da403ded59ea37 extends Template
{
...
<p>";
        // line 11
        yield t("The core software allows you to configure workflows in which each transition has an associated permission that can be granted to a particular role. See @configuring_workflows_topic for more information.", ["@configuring_workflows_topic" => ($context["configuring_workflows_topic"] ?? null), ]);
        yield "</p>
<p>";
        // line 12
        yield t("Users with sufficient permissions can change the workflow state of a particular entity. See @changing_states_topic for more information.", ["@changing_states_topic" => ($context["changing_states_topic"] ?? null), ]);
        yield "</p>
<h2>";
        // line 13
