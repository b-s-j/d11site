...
class __TwigTemplate_437de92fdec16e24a388f5dc36986e4e extends Template
{
...
<ol>
  <li>";
        // line 20
        yield t("Find the entity that you want to moderate in either the content moderation view page, if you created one, or the appropriate administrative page for managing that type of entity (such as the administration page for content items; see @content_link).", ["@content_link" => ($context["content_link"] ?? null), ]);
        yield "</li>
  <li>";
        // line 21
