...
class __TwigTemplate_fdcbef85e7670e8a4d05bac224cdbc00 extends Template
{
...
";
        // line 75
        yield from $this->load("core/themes/olivero/templates/content/node--teaser.html.twig", 75, "429689815")->unwrap()->yield(CoreExtension::toArray(["attributes" => CoreExtension::getAttribute($this->env, $this->source,         // line 76
...
/* core/themes/olivero/templates/content/node--teaser.html.twig */
class __TwigTemplate_fdcbef85e7670e8a4d05bac224cdbc00___429689815 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    public function block_meta(array $context, array $blocks = []): iterable
    {
        ...
        <span";
          ...
          ";
            ...
            if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                if (array_key_exists("xb_slot_ids", $context) && in_array("author_name", $context["xb_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "start", $context["xb_uuid"], "author_name");
                } else {
                    yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "start", $context["xb_uuid"], "author_name");
                }
            }
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["author_name"] ?? null), "html", null, true);
            if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                if (array_key_exists("xb_slot_ids", $context) && in_array("author_name", $context["xb_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "end", $context["xb_uuid"], "author_name");
                } else {
                    yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "end", $context["xb_uuid"], "author_name");
                }
            }
            yield "</span>, ";
            if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                if (array_key_exists("xb_slot_ids", $context) && in_array("date", $context["xb_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "start", $context["xb_uuid"], "date");
                } else {
                    yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "start", $context["xb_uuid"], "date");
                }
            }
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["date"] ?? null), "html", null, true);
            if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                if (array_key_exists("xb_slot_ids", $context) && in_array("date", $context["xb_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "end", $context["xb_uuid"], "date");
                } else {
                    yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "end", $context["xb_uuid"], "date");
                }
            }
            yield "
        </span>
        ";
            // line 100
            if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                if (array_key_exists("xb_slot_ids", $context) && in_array("metadata", $context["xb_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "start", $context["xb_uuid"], "metadata");
                } else {
                    yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "start", $context["xb_uuid"], "metadata");
                }
            }
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["metadata"] ?? null), "html", null, true);
            if ((isset($context["xb_is_preview"]) && $context["xb_is_preview"]) && array_key_exists("xb_uuid", $context)) {
                if (array_key_exists("xb_slot_ids", $context) && in_array("metadata", $context["xb_slot_ids"], TRUE)) {
                    yield \sprintf('<!-- xb-slot-%s-%s/%s -->', "end", $context["xb_uuid"], "metadata");
                } else {
                    yield \sprintf('<!-- xb-prop-%s-%s/%s -->', "end", $context["xb_uuid"], "metadata");
                }
            }
            yield "
      </div>
  ...
  ";
    ...
    public function getDebugInfo(): array
    {
        return array (  363 => 113,  356 => 112,  351 => 111,  329 => 108,  324 => 107,  321 => 106,  314 => 105,  303 => 104,  298 => 103,  278 => 100,  241 => 98,  237 => 97,  234 => 96,  231 => 95,  224 => 94,  203 => 92,  184 => 91,  177 => 90,  165 => 75,  71 => 88,  70 => 87,  69 => 86,  68 => 85,  67 => 84,  66 => 83,  65 => 82,  64 => 81,  63 => 80,  62 => 79,  61 => 78,  60 => 77,  59 => 76,  58 => 75,  54 => 73,  52 => 70,  51 => 69,  50 => 68,  49 => 67,  48 => 66,  47 => 64,  44 => 62,);
    }
