...
class __TwigTemplate_e09e061849b5dd2af0fe8e0b7d75d228 extends Template
{
...
<ol>
  <li>";
        // line 19
        yield t("In the <em>Manage</em> administrative menu, navigate to <em>Configuration</em> &gt; <em>Media</em> &gt; <em>@styles_link</em>.", ["@styles_link" => ($context["styles_link"] ?? null), ]);
        yield "</li>
  <li>";
        // line 20
  ...
  <li>";
        // line 23
        yield t("Select a <em>Fallback image style</em> to use when none of the other styles apply. See @image_style_topic if you need to add a new style.", ["@image_style_topic" => ($context["image_style_topic"] ?? null), ]);
        yield "</li>
  <li>";
        // line 24
