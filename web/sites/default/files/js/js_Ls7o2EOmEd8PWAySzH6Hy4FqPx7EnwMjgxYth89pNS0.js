...
(function($,Drupal){Drupal.behaviors.dynamicPricing={attach:function(context,settings){console.log("Pricing assets loaded!");}};})(jQuery,Drupal);;
...
(function($,Drupal,once){'use strict';Drupal.behaviors.webformHelpDialog={attach(context){$(once('webform-help-dialog','.button-webform-play',context)).on('click',function(event){if($(window).width()<768)event.stopImmediatePropagation();}).each(function(){var handlers=$._data(this,'events')['click'];var handler=handlers.pop();handlers.splice(0,0,handler);});}};})(jQuery,Drupal,once);;
