...
(function(){const STORAGE_KEY='XBPreviousURL';const currentUrl=window.location.href;const inIframe=window.self!==window.top||currentUrl==='about:srcdoc';if(inIframe)return;sessionStorage.setItem(STORAGE_KEY,currentUrl);})();;
